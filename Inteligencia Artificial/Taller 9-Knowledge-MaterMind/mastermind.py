...
# Sabemos que existen 2 colores en una posición correcta y 2 colores en una posición incorrecta
knowledge.add(Or(
...
# sabemos ningún color esta en la posición correcta
knowledge.add(And(
    Not(Symbol("blue0")),
    Not(Symbol("red1")),
    Not(Symbol("green2")),
